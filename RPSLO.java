        ...
        public static void main(String[] args) {
         ...
         Scanner scanner = new Scanner(System.in);
           ...
           if((users_play == 'r')||(users_play == 'p')||(users_play == 's')||(users_play == 'l')||(users_play == 'o')||(users_play == 'R')||(users_play == 'P')||(users_play == 'S')||(users_play == 'L')||(users_play == 'O'))
          {
                ...
                System.out.println("Computer play is "+computers_choice);
              ...
              switch(users_play)
              {
                 ...
                 case ('p'):
                  ...
                  case ('r'):
                      if(computers_choice=='L') winner = 'u';
                          ...
                          else if(computers_choice=='R') winner = 't';
                      break;  
                    case ('l'):
               ...
               if(winner=='c') System.out.println("Computer wins!");
               else if(winner=='u')System.out.println("You win!");
               else if(winner=='t')System.out.println("It is a tie!");
         }  
         else System.out.println("Invalid input (valid inputs: R, P, S, L, O)");
